...
Runs indicators/risk.py over every stock's
price history in raw.daily_prices and upserts into
features.risk_features.

Usage:

python feature_generators/risk_features.py

python feature_generators/risk_features.py --symbol RELIANCE
"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Generate Risk Features"
    )
